...
.intro-title {
  font-weight: 700;
  padding-bottom: 50px;
  background-image: -webkit-linear-gradient(left, black 25%, #C6FFDD 45%, #FBD786, #f7797d 62.5%, black 75%);
  background-image: linear-gradient(70deg, black 25%, #C6FFDD 45%, #FBD786, #f7797d 62.5%, black 75%);
